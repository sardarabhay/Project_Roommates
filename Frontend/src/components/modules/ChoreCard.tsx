...
const ChoreCard = ({ task, onUpdateStatus, onClaimTask, onEdit, onDelete, currentUser }: ChoreCardProps): JSX.Element => {
  const isMyTask = task.assignedToUser?.id === currentUser?.id;
  ...
  const getDueDateStatus = (): DueDateInfo | null => {
        ...
        <div className="flex items-center">
          {assignee ? (
            ...
            <div className="flex items-center text-sm text-gray-500">
              <UserIcon className="w-6 h-6 rounded-full mr-2 p-1 bg-gray-200 dark:bg-gray-700"/>
